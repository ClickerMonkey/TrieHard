...
public class TrieCollection<S, T, C extends Collection<T>> extends Trie<S, C>
{
    ...
    * @param supplier
    * 		 The function which creates new collections on demand.
    */
    ...
    *        If this Trie should return an empty collection if a query is done
   ...
   /**
    * Returns a TrieCollection with the same default value, match, and
    * {@link TrieSequencer} as this TrieCollection.
    * 
    ...
    *        The sequence.
    * @param value
    *        The value to place in the collection.
    * @return 
    * 		The collection at the given sequence.
    */
    ...
    *        The sequence.
    * @param values
    *        The {@link Iterable} of values to place in the collection.
    * @return 
    * 		The collection at the given sequence.
    */
